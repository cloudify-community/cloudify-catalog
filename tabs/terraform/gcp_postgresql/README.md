# GCP Postgresql Provisioning

## General

The blueprint creates GCP Cloud Postgresql instance.
...
The created deployment will have label `obj-type` equal to `service`, `gcp` & `Postgresql`