...
The blueprint creates GCP Cloud network and compute instance. The created LB routes the traffic to the compute instance.
...
The created deployment will have label `obj-type` equal to `service`, `gcp` & `network`