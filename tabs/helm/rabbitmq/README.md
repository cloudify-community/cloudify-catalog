# Rabbitmq Helm Chart Blueprint

## General

The blueprint installs Rabbitmq on top of Kubernetes cluster using the official Bitnami Helm chart.
...
Example:
```shell
cfy install blueprint.yaml -b helm-Rabbitmq -d helm-Rabbitmq -l csys-obj-parent=EKS_DEPLOYMENT_ID
```
...
| Name of the helm release          | release_name  | string | exampleRabbitmq |
...
### Release
the node type is responisble for installing the Rabbitmq deployment using the official Bitnami chart.
...
| Name          | Description                           |
| ------------- | ------------------------------------- |
| url           | URL of the Rabbitmq app              |
| login_page    | Login page of the Rabbitmq console   |