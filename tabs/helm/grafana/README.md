# Grafana Helm Chart Blueprint

## General

The blueprint installs Grafana on top of Kubernetes cluster using the official Bitnami Helm chart.
...
| Name             | Description                           |
| ---------------- | ------------------------------------- |
| url              | URL of the Grafana app                |
| grafana_password | Password for the admin of the Grafana |