...
The blueprint installs Drupal on top of Kubernetes cluster using the official Bitnami Helm chart.
...
| Name of the helm release          | release_name  | string | exampledrupal    |
...
### Release
the node type is responisble for installing the Drupal deployment using the official Bitnami chart.
...
| Name          | Description                           |
| ------------- | ------------------------------------- |
| url           | URL of the Drupal app                 |
| login_page    | Login page of the Drupal console      |