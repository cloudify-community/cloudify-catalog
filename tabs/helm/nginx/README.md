# Nginx Helm Chart Blueprint

## General

The blueprint installs Nginx on top of Kubernetes cluster using the official Bitnami Helm chart.
...
Example:
```shell
cfy install blueprint.yaml -b helm-nginx -d helm-nginx -l csys-obj-parent=K8S_DEPLOYMENT_ID
```
...
### Release
the node type is responisble for installing the Nginx deployment using the official Bitnami chart.
