# Prometheus Stack Helm Chart Blueprint

## General

The blueprint installs Prometheus Stack on top of Kubernetes cluster using the official Bitnami Helm chart.
...
Example:
```shell
cfy install blueprint.yaml -b helm-prometheus-stack -d helm-prometheus-stack -l csys-obj-parent=K8S_DEPLOYMENT_ID
```
...
| Name              | Description                        |
| ----------------- | ---------------------------------- |
| grafana_page      | Login page of the Grafana console  |
| grafana_password  | Password of the Grafana console    |