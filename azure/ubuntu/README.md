...
The blueprint creates Ubuntu VM with the usage of the ARM template (the Public IP properties was change to provide IPv4 Static IP address) - details [here](https://docs.microsoft.com/en-us/azure/virtual-machines/linux/create-ssh-secured-vm-from-template). 
...
### Ubuntu Deployment
The node type is responsible for deploying the VM in the Azure cloud.\
